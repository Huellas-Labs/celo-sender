...
const HomeHeader = (props) => {
    ...
    const getTokensInAccount = async () => {
        ...
        let rootPath = 'https://api.covalenthq.com/v1/' + Number(props.connectionDetails.chainId) + '/address/' + props.connectionDetails.account + '/balances_v2/?key=cqt_rQhQ3mT8yjHgtQXRCyfmQMrYt6kF';
